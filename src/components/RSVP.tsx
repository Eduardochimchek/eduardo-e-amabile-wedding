          ...
          <div data-m="up" className="mx-auto mt-12 max-w-xl">
            ...
            {step === "pick" ? (
              <div className="space-y-5">
                <div className="text-center">
                  <p className="font-sans text-2xl text-warm sm:text-3xl">
            ...
            {step === "invite" && invitation ? (
              <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                <div className="text-center">
                  <p className="inline-flex items-center gap-2 font-sans text-2xl text-warm sm:text-3xl">
            ...
            {step === "success" ? (
              <div className="space-y-4 text-center">
                ...
                <p
                  role="status"
                  className="rsvp-feedback rsvp-feedback--ok font-sans text-2xl text-serenity"
                >
