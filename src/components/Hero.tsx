  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0" aria-hidden="true">
        <div className="absolute inset-0 bg-[linear-gradient(160deg,#2F485D_0%,#1E3A8A_42%,#4F7DBA_72%,#8FAFC5_100%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_30%_20%,rgba(216,198,165,0.18),transparent_50%),radial-gradient(ellipse_at_80%_70%,rgba(125,138,112,0.16),transparent_45%)]" />
      ...
      <div className="section-shell relative z-10 w-full pb-16 pt-28 md:pb-24 md:pt-32">
        <div className="mx-auto max-w-3xl text-center text-warm">
          <p className="mb-8 text-[0.7rem] font-medium uppercase tracking-[0.28em] text-champagne/90">
            Nosso casamento
          </p>
          ...
          <p className="mt-8 font-display text-2xl tracking-[0.35em] text-warm/95 sm:text-3xl">
            {date.displayCompact}
          </p>

          <div className="gold-rule mx-auto mt-8 opacity-80" aria-hidden="true" />

          <p className="mx-auto mt-8 max-w-md text-sm leading-relaxed text-warm/85 sm:text-base">
            {copy.heroTagline}
          </p>
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row">
            ...
            <a
              href="#historia"
              className="btn-ghost min-w-[12rem] border-warm/30 text-warm hover:border-gold hover:bg-warm/10"
            >
              Nossa história
            </a>
          </div>
