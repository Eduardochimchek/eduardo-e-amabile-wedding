...
export const storyChapters: StoryChapter[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "E, no caminho, a família cresceu. As gatinhas Mili e Nina chegaram para completar a história, e hoje somos nós quatro em cada capítulo dessa vida que construímos juntos.",
    ],
